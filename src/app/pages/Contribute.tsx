...
export function Contribute() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 4. Automatically create a photographer account
      try {
        const tempPassword =
        ...
        const lastName = nameParts.slice(1).join(" ") || "Photographer";
        ...
        // If successful, send the auto-generated email
        if (!error && data?.user) {
          await sendAutoGeneratedAccountEmail(cleanEmail, cleanName, tempPassword);
        } else if (error) {
          console.warn("User might already exist or sign-up failed:", error.message);
        }
      } catch (err) {
    ...
    <div className="bg-[#fcfcfa] text-[#18211f]">
      ...
      <section className="bg-[#182e27] text-[#f4f1e9] py-14 px-5 sm:px-8 lg:px-12 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1440px]">
          <p className="font-mono text-xs tracking-[0.24em] text-white/50">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-white/80">
            Bridging the gap between independent photographic talent and global commercial
            enterprise. Sourcing, evaluating, and licensing imagery that inspires audiences and
            elevates campaign aesthetics.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1440px] px-5 py-20 sm:px-8 lg:px-12 grid gap-12 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-6 text-base leading-relaxed text-[#59645f]">
            Welcome to NS CAPTURES, a premier international visual media acquisition firm dedicated
            to bridging the gap between independent photographic talent and global commercial
            enterprise. We specialize in sourcing, evaluating, and licensing high-end imagery that
            commands attention, inspires audiences, and elevates modern corporate and editorial
            campaigns.
          </p>

          <h3 className="mt-8 font-serif text-xl text-[#1e4a3f]">Our Mission</h3>
          <p className="mt-3 text-sm leading-relaxed text-[#59645f]">
            Our mission is simple: to discover exceptional photographic perspectives from around the
            globe and integrate them into the international commercial marketplace. We believe that
            every image tells a story, and our goal is to provide talented photographers—from
            seasoned film enthusiasts utilizing traditional mediums to digital pioneers working with
            cutting-edge medium-format systems—with a direct pipeline to monetize their unique
            creative vision.
          </p>
        </div>
        ...
        <div className="bg-[#f0ece6] p-8 rounded-3xl border border-[#ececec]">
          ...
          <h3 className="mt-3 font-serif text-2xl text-[#18211f]">
            A Streamlined Digital Asset Pipeline
          </h3>

          <div className="mt-8 space-y-6">
            <div className="flex gap-4">
              <div className="h-10 w-10 shrink-0 bg-[#1e4a3f] text-white rounded-full flex items-center justify-center font-bold">
                1
              </div>
              <div>
                <h4 className="font-serif text-lg">Talent Acquisition & Sourcing</h4>
                <p className="text-sm text-[#59645f] mt-1">
                  Identify emerging and established photographers who possess a distinct, premium
                  artistic voice.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#59645f] mt-1">
                  Exhaustive metadata, composition, sharpness, color fidelity and authentic
                  authorship checks by our dedicated Content Evaluation Team.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#59645f] mt-1">
                  Legally secure, pristine visual content packaged directly for major international
                  agencies, corporate partners and publishers.
                </p>
              </div>
            </div>
          </div>
          ...
          <p className="mt-8 text-xs leading-relaxed text-[#758078] italic">
            By managing structural evaluation, copyright assignment compliance, legal encryption,
            and international banking clearing, we guarantee high-value, transparent licensing.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1440px]">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="mt-3 font-serif text-3xl sm:text-4xl">
              Tier-Structured Acquisition Valuations
            </h2>
            <p className="mt-4 text-sm leading-relaxed text-[#59645f]">
              We acquire digital and film assets based on commercial demand, technical execution,
              and artistic composition. Once submitted, your portfolio is evaluated and placed into
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <div className="bg-white border border-[#ececec] p-8 rounded-2xl ns-shadow-sm flex flex-col justify-between">
              <div>
                <span className="font-mono text-[10px] tracking-wider uppercase text-[#8a8f89]">
                  Acquisition Tier 01
                </span>
                ...
                <p className="text-sm text-[#59645f] mt-4 leading-relaxed">
                  Clean composition, clear sharpness, and high utility for digital media and
                  corporate marketing.
                </p>
              </div>
            ...
            <div className="bg-white border-2 border-[#1e4a3f] p-8 rounded-2xl relative flex flex-col justify-between shadow-md">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-[#1e4a3f] px-4 py-1 text-[9px] font-mono tracking-wider text-white uppercase">
                High-Demand
              </div>
              <div>
                <span className="font-mono text-[10px] tracking-wider uppercase text-[#1e4a3f]">
                  Acquisition Tier 02
                </span>
                <h3 className="font-serif text-2xl text-[#18211f] mt-2">Premium Editorial</h3>
                <p className="text-sm text-[#59645f] mt-4 leading-relaxed">
                  Exceptional dynamic range, advanced lighting, or specialized subject matter (e.g.,
                  medium format, premium drone, specialized architecture).
                </p>
              </div>
              <div className="border-t border-[#ececec] pt-6 mt-6">
                <span className="text-xs text-[#8a8f89]">Valuation Per Photo</span>
            ...
            <div className="bg-white border border-[#ececec] p-8 rounded-2xl ns-shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-[#59645f] mt-4 leading-relaxed">
                  Rare, high-demand aesthetics, immaculate metadata validation, or pristine film
                  scans with unique artistic value.
                </p>
              </div>
              <div className="border-t border-[#ececec] pt-6 mt-6">
                <span className="text-xs text-[#8a8f89]">Valuation Per Photo</span>
      ...
      <section className="mx-auto max-w-[1440px] px-5 py-20 sm:px-8 lg:px-12">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-sm text-[#59645f]">
            Understand the transition from initial digital asset submission to legal contract
            clearance and final disbursement payout.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div
              key={idx}
              className="bg-white border border-[#ececec] rounded-2xl p-6 relative shadow-sm"
            >
              <div className="absolute top-6 right-6 font-mono text-xs text-[#1e4a3f] font-bold bg-[#1e4a3f]/10 px-2.5 py-1 rounded-full">
                {item.step}
              </div>
            ...
            <div className="bg-white text-[#18211f] p-8 rounded-3xl shadow-2xl border border-white/10">
              <div className="border-b border-[#ececec] pb-6 mb-6">
                ...
                <p className="text-xs text-[#59645f] mt-2">
                  Ready to partner with NS CAPTURES? Please fill out the formal acquisition intake
                  form below. Ensure your cloud folder permissions are set to{" "}
                  <strong className="text-[#1e4a3f]">\"Anyone with the link can view\"</strong>{" "}
                  before submitting.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="py-12 text-center">
                  ...
                  <h4 className="font-serif text-2xl text-[#18211f] font-semibold">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid gap-5 sm:grid-cols-2">
                    ...
                    <div>
                      <label className="block text-xs font-mono tracking-wider text-[#59645f] uppercase mb-2">
                        Social Media Handle / Instagram (Optional)
                      </label>
                      <input
                        type="text"
                        value={socialHandle}
                  ...
                  <div>
                    <label className="block text-xs font-mono tracking-wider text-[#59645f] uppercase mb-2">
                      Portfolio Link (Google Drive / Dropbox) *
                    </label>
                    <input
                      type="url"
                      required
                  ...
                  <div className="bg-[#f0ece6] rounded-2xl p-4 text-[11px] leading-relaxed text-[#59645f] border border-[#ececec]">
                    <strong>Submission Agreement:</strong> By clicking submit, you acknowledge that
                    all submitted visual assets are your original intellectual property, free of
                    unmentioned third-party claims. NS CAPTURES reserves the right to decline
                    portfolios that fail to clear metadata verification. First-time vendors are
                    subject to mandatory regulatory profile registration via our partner compliance
                    law firm prior to any contract finalization.
                  </div>
            ...
            <div className="flex flex-col justify-between py-4 text-white/90">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-serif text-base text-white">
                        Legal Tracing &amp; Verification
                      </h4>
                      <p className="text-xs text-white/60 mt-1">
                        Authorship tracking and metadata integrity checking are mandatory to protect
                        licensees.
                      </p>
                    </div>
                  </div>
              ...
              <div className="border-t border-white/15 pt-8 mt-8 space-y-4">
                ...
                <p className="text-xs text-white/70">
                  Contact our corporate departments directly regarding active evaluations or
                  registration status:
                </p>
                ...
                <div className="grid gap-3 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      General Acquisition:{" "}
                      <a href="mailto:sales@nscaptures.com" className="underline hover:text-white">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      Billing &amp; Compliance:{" "}
                      <a
                        href="mailto:paymentdesk@nscaptures.com"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      ...
                      <a
                        href="https://wa.me/message/NSCAPTURES"
                        target="_blank"
      ...
      <section className="mx-auto max-w-[1440px] px-5 py-20 sm:px-8 lg:px-12">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <Eyebrow>FAQ</Eyebrow>
          <h2 className="mt-3 font-serif text-3xl sm:text-4xl text-[#18211f]">
            Frequently Asked Questions
          </h2>
          <p className="mt-4 text-sm text-[#59645f]">
            Addressing the key licensing, gear requirements and legal setup queries often raised by
            incoming photographers.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3 max-w-5xl mx-auto">
          <div className="bg-white border border-[#ececec] p-6 rounded-2xl ns-shadow-sm flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-[#59645f] mt-3 leading-relaxed">
                We accept high-resolution digital imagery—ranging from APS-C to medium format
                systems—as well as clean, high-resolution physical film scans. The asset's
                composition and commercial readiness dictate the valuation more than the specific
                gear model.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#ececec] p-6 rounded-2xl ns-shadow-sm flex flex-col justify-between">
            <div>
              ...
              <h4 className="font-serif text-lg text-[#18211f]">
                Can registration fees be deducted?
              </h4>
              <p className="text-xs text-[#59645f] mt-3 leading-relaxed">
                Due to strict international anti-money laundering frameworks and corporate
                accounting laws, gross acquisition disbursements cannot be mixed with administrative
                profile activations. The activation invoice must be cleared independently through
                our legal compliance partners before payout release.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#ececec] p-6 rounded-2xl ns-shadow-sm flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-[#59645f] mt-3 leading-relaxed">
                Our standard contract involves an exclusive commercial acquisition or an extensive
                international licensing transfer depending on the tier. Full details regarding
                copyright assignment are clearly laid out in your individualized agent contract
                prior to signing.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#101e1a] border-t border-[#ececec]/10 py-12 px-5 sm:px-8 lg:px-12 text-white/50 text-[11px] leading-relaxed">
        <div className="mx-auto max-w-[1440px] grid gap-6 md:grid-cols-[1fr_2.5fr]">
          <div className="font-mono tracking-wider uppercase text-white/80">
            Regulatory Compliance Notice
          </div>
          <div>
            <p>
              NS CAPTURES operates under strict compliance with international copyright frameworks,
              digital asset monetization standards, and cross-border commercial trade regulations.
              All submitted portfolios undergo mandatory authorship tracing and metadata tracking to
              protect legal licensees. Vendor profile setup, secure asset encryption, and final
              payment disbursements are processed exclusively in tandem with certified legal counsel
              and corporate compliance clearing houses.
            </p>
          </div>
        </div>
      </section>

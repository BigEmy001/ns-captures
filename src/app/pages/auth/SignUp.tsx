      ...
      >
        <div className="rounded-2xl border border-[#ececec] bg-[#f8f9f7] p-8 text-center space-y-4">
          <div className="mx-auto flex size-12 items-center justify-center rounded-full bg-[#1e4a3f]/10">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1e4a3f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h8"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/><path d="m16 19 2 2 4-4"/></svg>
          </div>
          <p className="text-sm text-[#4a534e]">
            Click the secure link in the email sent to <strong className="text-[#18211f] font-semibold">{email}</strong> to complete your registration.
          </p>
          <p className="text-xs text-[#9aa09b]">
            If you don't see it, check your spam folder or <button onClick={() => setIsSuccess(false)} className="text-[#1e4a3f] hover:underline">try again</button>.
          </p>
        </div>
        <div className="mt-8">
          <Link to="/signin" className="w-full inline-flex justify-center rounded-full border border-[#ececec] bg-white py-3 text-sm font-semibold text-[#18211f] transition hover:bg-[#f8f9f7]">
            Return to sign in
          </Link>
        </div>
      </AuthLayout>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <button
            ...
            className={`flex flex-col items-center gap-2 rounded-xl border p-3 text-xs transition ${
              role === "Buyer" ? "border-[#1e4a3f] bg-[#1e4a3f]/5 text-[#1e4a3f] font-semibold" : "border-[#ececec] bg-white text-[#6b716d] hover:bg-[#f8f9f7]"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-2 rounded-xl border p-3 text-xs transition ${
              role === "Photographer" ? "border-[#1e4a3f] bg-[#1e4a3f]/5 text-[#1e4a3f] font-semibold" : "border-[#ececec] bg-white text-[#6b716d] hover:bg-[#f8f9f7]"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-2 rounded-xl border p-3 text-xs transition ${
              role === "Enterprise" ? "border-[#1e4a3f] bg-[#1e4a3f]/5 text-[#1e4a3f] font-semibold" : "border-[#ececec] bg-white text-[#6b716d] hover:bg-[#f8f9f7]"
            }`}
          >

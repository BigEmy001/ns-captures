...
const licenseRows = [
  { license: "Editorial", usage: "News, education, blogs, non-commercial purposes", from: 130, details: "Allowed: Editorial uses like newspapers, textbooks, documentaries, personal blogs. Not allowed: Any advertising, commercial promotions, or business branding." },
  { license: "Commercial", usage: "Advertising, business web, social media, marketing", from: 180, details: "Allowed: Corporate websites, advertisements, promotional campaigns, social media posts for business. Not allowed: Merchandise resale or printing on physical products for sale." },
  { license: "Extended", usage: "Merchandise, print-on-demand, packaging, physical products", from: 450, details: "Allowed: Printing on merchandise (t-shirts, mugs, prints), physical product packaging, books for resale, unlimited prints. Not allowed: Exclusive ownership." },
  { license: "Exclusive", usage: "Sole ownership rights, item removed from archive", from: 1200, details: "Allowed: Complete and exclusive usage rights. Once purchased, the image is permanently deleted from the NS CAPTURES archive and cannot be licensed by others." },
];
    ...
    <div className="mx-auto max-w-[1440px] px-5 py-14 sm:px-8 lg:px-12">
      <div className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-lg text-[#59645f]">
          License single images à la carte. No recurring subscription lock-ins, complex tokens, or confusing legal terms.
        </p>
      </div>

...
const Contribute = lazy(() =>
  import("./pages/Contribute").then((m) => ({ default: m.Contribute })),
);
const PhotographerProfile = lazy(() =>
  import("./pages/PhotographerProfile").then((m) => ({ default: m.PhotographerProfile })),
);
...
const Proposal = lazy(() => import("./pages/Proposal").then((m) => ({ default: m.Proposal })));

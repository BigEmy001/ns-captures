...
--
-- Editorial spotlight for the homepage's featured photographer.
...
ALTER TABLE public.site_settings
  ...
  ADD COLUMN IF NOT EXISTS featured_spotlight_headline text NOT NULL DEFAULT 'Featured Photographer',
...
SET
  ...
  featured_spotlight_headline = 'Featured Photographer',

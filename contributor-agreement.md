...
For the NS CAPTURES platform, I would make this the master Contributor Agreement that the photographer accepts when joining.

Then, inside the contributor dashboard, the photographer should subsequently see separate documents when applicable:
